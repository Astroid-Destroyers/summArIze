            ...
            <nav className="space-y-1">
              {features.map((feature) => (
                <button
                  ...
                  className={`group w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 relative ${
            ...
            {features.slice(0, 5).map((f) => (
              <button
                ...
                className={`flex flex-col items-center gap-1 px-3 py-2 rounded-xl transition-all ${
                  activeTab === f.id ? "text-violet-400" : "text-gray-500"
                }`}
              >
        ...
        <div className="flex-1 px-6 lg:px-10 py-8 pb-24 lg:pb-8">
          {activeTab === "upload" ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <button
                      ...
                      className={`group relative p-6 rounded-xl border-2 transition-all duration-300 hover:scale-[1.02] ${
            ...
            <div className="max-w-4xl mx-auto text-center py-20">
              ...
              <p className="text-gray-400 max-w-md mx-auto">This feature is currently under development. Stay tuned for updates!</p>
            </div>
          )}
        </div>
      </div>
